...
#define STRING_CONFIG_H_AUTHOR "(Drew, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ronnie the Replicator 2.0"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -9, -2.55 }
